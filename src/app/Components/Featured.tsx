...
//     return (
//             <main className="w-full h-[461px] bg-white px-5 md:px-10 lg:px-60 py-8 md:py-16 lg:py-[100px]">
//                 <h1 className="text-[#272343] text-[32px] font-semibold">Featured Products</h1>
...
//                                         </div>
//                                         <div className="w-14 h-14 rounded-xl bg-[#F0F2F3] hover:bg-[#029FAE] hover:text-white p-3 pt-4">
...
return (
    <>
      ...
      <main className="w-full bg-white px-5 md:px-10 lg:px-28 xl:px-48 py-8 md:py-16 lg:py-[100px]">
        <h1 className="text-[#272343] text-[24px] md:text-[32px] font-semibold text-center mb-8">
          Featured Products
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 place-items-center">
          {Products.map((item) => (
            <div
              className="relative w-full max-w-[300px] mx-auto h-auto p-4 bg-[#f9f9f9] rounded-lg shadow-md"
              key={item.id}
            >
              <Image
              ...
              <div className="flex justify-between items-center py-4">
                <div className="space-y-2">
                  <h6 className="text-[#007580] text-[16px] font-medium">{item.name}</h6>
                  <h5 className="font-semibold text-[18px] text-[#272343]">
                    {`$${item.price} `}
                    <del className="text-[#007580] text-[16px]">{item.discount}</del>
                  </h5>
                </div>
                <div className="w-14 h-14 rounded-xl bg-[#F0F2F3] hover:bg-[#029FAE] hover:text-white p-3 flex items-center justify-center cursor-pointer">
                  <svg
                    width="20"
                    height="19"
                    viewBox="0 0 20 19"
                  ...
                  >
                    <path
                      d="M1.52075 0.979172L3.42742 1.30917L4.31017 11.8261C4.34408 12.2399 4.53278 12.6258 4.83861 12.9066C5.14445 13.1875 5.54494 13.3427 5.96017 13.3413H15.961C16.3586 13.3418 16.743 13.1987 17.0434 12.9383C17.3439 12.6779 17.5402 12.3178 17.5963 11.9242L18.4672 5.91267C18.4904 5.7528 18.4819 5.58991 18.4421 5.43334C18.4023 5.27676 18.332 5.12956 18.2353 5.00015C18.1386 4.87075 18.0173 4.76168 17.8784 4.67918C17.7395 4.59667 17.5857 4.54236 17.4258 4.51934C17.3672 4.51292 3.73359 4.50834 3.73359 4.50834"
                      stroke="#272343"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M15.8988 16.5194C16.0312 16.5194 16.1583 16.5721 16.252 16.6657C16.3457 16.7594 16.3983 16.8865 16.3983 17.019C16.3983 17.1515 16.3457 17.2786 16.252 17.3723C16.1583 17.466 16.0312 17.5186 15.8988 17.5186C15.7663 17.5186 15.6392 17.466 15.5455 17.3723C15.4518 17.2786 15.3992 17.1515 15.3992 17.019C15.3992 16.8865 15.4518 16.7594 15.5455 16.6657C15.6392 16.5721 15.7663 16.5194 15.8988 16.5194Z"
                      fill="#272343"
                      stroke="#272343"
                      strokeWidth="1.5"
                      strokeLinecap="round"
