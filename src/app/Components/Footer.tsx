...
return (
    <main className="bg-white">
        <div className="w-full h-auto border-y border-black border-opacity-20">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-between w-full h-full py-10 px-5 md:px-10 lg:px-28 xl:px-48">
                {/* Brand Section */}
                <div className="space-y-7">
                    ...
                    <svg className="lg:w-[40px] lg:h-[40px] w-[20px] h-[20px] md:w-[30px] md:h-[30px]" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 className="text-[20px] lg:text-[26px] font-medium text-[#272343]">Comforty</h1>
                    </div>
                    <p className="text-[#9A9CAA] text-sm md:text-base">
                        Vivamus tristique odio sit amet velit semper, eu posuere turpis interdum. Cras egestas purus.
                    </p>
                    <div className="hidden lg:flex gap-5">
                            <div className="relative w-[40px] h-[40px] bg-transparent border-2 border-[#636270] border-opacity-0 hover:border-opacity-100 rounded-full p-[8.5px]">
                            <FaFacebook className="absolute h-[20px] w-[20px] fill-[#636270]"/>
                            </div>
                            <div className="relative w-[40px] h-[40px] bg-transparent border-2 border-[#636270] border-opacity-0 hover:border-opacity-100 rounded-full p-[8.5px]">
                            <FaTwitter className="absolute h-[20px] w-[20px] fill-[#636270]"/>
                            </div>
                            <div className="relative w-[40px] h-[40px] bg-transparent border-2 border-[#636270] border-opacity-0 hover:border-opacity-100 rounded-full p-[8.5px]">
                            <FaInstagram className="absolute h-[20px] w-[20px] fill-[#636270]"/>
                            </div>
                            <div className="relative w-[40px] h-[40px] bg-transparent border-2 border-[#636270] border-opacity-0 hover:border-opacity-100 rounded-full p-[8.5px]">
                            <FaPinterest className="absolute h-[20px] w-[20px] fill-[#636270]"/>
                            </div>
                            <div className="relative w-[40px] h-[40px] bg-transparent border-2 border-[#636270] border-opacity-0 hover:border-opacity-100 rounded-full p-[8.5px]">
                            <FaYoutube className="absolute h-[20px] w-[20px] fill-[#636270]"/>
                            </div>   
                    </div>
                </div>
                ...
                {/* Categories Section */}
                <div>
                    <h2 className="text-[#9A9CAA] text-sm lg:text-base font-medium">CATEGORY</h2>
                    <div className="flex flex-col text-[#272343] space-y-2 text-sm md:text-base">
                        <a href="#">Sofa</a>
                        <a href="#">Armchair</a>
                        <a href="#">Wing Chair</a>
                        <a href="#">Desk Chair</a>
                ...
                {/* Support Section */}
                <div>
                    <h2 className="text-[#9A9CAA] text-sm lg:text-base font-medium">SUPPORT</h2>
                    <div className="flex flex-col text-[#272343] space-y-2 text-sm md:text-base">
                ...
                <div className="space-y-5">
                    <h2 className="text-[#9A9CAA] text-sm lg:text-base font-medium">NEW SETTLER</h2>
                    <div className="space-y-2">
                        <div className="flex flex-col xl:flex-row gap-4">
                            <input
                                type="email"
                                className="flex-1 h-14 lg:h-12 min-h-[48px] px-4 border rounded-lg outline-none"
                                placeholder="Your Email"
                            />
                            <button className="w-full md:w-auto h-12 bg-[#029FAE] text-white font-semibold rounded-lg">
                                Subscribe
                            </button>
                        </div>
                        <p className="text-[#9A9CAA] text-sm md:text-base">
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime adipisci fugit.
                        </p>
                    </div>
                </div>
            </div>
            ...
            {/* Social Media Icons */}
            <div className="w-full px-5 md:px-10 lg:px-28 xl:px-48">
                <div className="flex flex-col-reverse lg:flex-row justify-between items-center py-5">
                    <div className="text-[#9A9CAA] text-xs md:text-sm">
                        @ 2024 - Blogy - Designed & Developed by <span className="text-[#272343]">Abdul Waheed</span>
                    </div>
                    <div className="lg:hidden flex gap-3 my-4 lg:my-0">
                            <div className="relative w-[40px] h-[40px] bg-transparent border-2 border-[#636270] border-opacity-0 hover:border-opacity-100 rounded-full p-[8.5px]">
                            <FaFacebook className="absolute h-[20px] w-[20px] fill-[#636270]"/>
                            </div>
                            <div className="relative w-[40px] h-[40px] bg-transparent border-2 border-[#636270] border-opacity-0 hover:border-opacity-100 rounded-full p-[8.5px]">
