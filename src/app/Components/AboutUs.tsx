        ...
        <>
            <main className="bg-white w-full h-full px-5 md:px-10 lg:px-28 xl:px-48 py-20">
                ...
                <div className="py-20">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-20 pt-10 place-items-center">
                        <div className="bg-[#f9f9f9] flex flex-col justify-between w-auto h-auto md:w-80 md:h-64 p-8 space-y-3">
                            <div className="space-y-4">
                                ...
                                <h5 className="text-[#007580] text-[16px] md:text-[20px]">Next day as standard</h5>
                            </div>
